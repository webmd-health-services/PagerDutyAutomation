...
.DESCRIPTION
The `Initialize-PagerDutyAutomationTest.ps1` script gets your tests ready to run by:
...
{
    $modules = [ordered]@{
        'PagerDutyAutomation' = '..\PagerDutyAutomation';
        'PagerDutyAutomationTestHelper' = 'PagerDutyAutomationTestHelper';
    }
